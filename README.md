...
<div align="left">
   ...
   <br/>
   <div align="left">
      <img src="https://skillicons.dev/icons?i=html,css,javascript,typescript,react,kotlin,reactnative,flutter,,bootstrap,tailwind,sass,materialui,redux,jest,cypress,selenium,nodejs,expressjs,laravel,rails,vite,kafka,php,mysql,postgresql,mongodb,redis,prisma,postman,docker,kubernetes,terraform,jenkins,graphql,apollo,vercel,googlecloud,firebase,aws,python,tensorflow,r,c,rust,zig,go,lua,ruby,java,git,github,vscode,androidstudio,npm,bash,linux" />
   </div>
</div>
