...
<div align="left">
   ...
   <br/>
   <div align="left">
      <img src="https://skillicons.dev/icons?i=html,css,javascript,typescript,figma,react,flutter,bootstrap,tailwind,sass,materialui,redux,jest,cypress,selenium,nodejs,expressjs,laravel,rails,vite,kafka,php,mysql,postgresql,mongodb,redis,prisma,postman,swagger,docker,kubernetes,terraform,prometheus,jenkins,graphql,apollo,vercel,googlecloud,firebase,aws,python,pytorch,tensorflow,r,c,rust,zig,go,lua,ruby,kotlin,java,git,github,vscode,androidstudio,npm,bash,linux" />
   </div>
</div>
