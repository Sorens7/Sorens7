...
<div align="left">
   ...
   <br/>
   <div align="left">
      <img src="https://skillicons.dev/icons?i=html,css,javascript,typescript,react,bootstrap,tailwind,sass,materialui,redux,jest,cypress,selenium,nodejs,expressjs,laravel,rocketrs,vite,php,mysql,postgre,mongodb,redis,prisma,postman,docker,kubernetes,buildout,jenkins,vercel,googlecloud,aws,python,tensorflow,r,c,rust,zig,go,java,git,github,vscode,npm,bash,linux" />
   </div>
</div>
